...
const OlvidePassword = () => 
{
    ...
    const handleSubmit = async e =>
    {
        ...
        try 
        {
            const { data } = await clientaAxios.post('/veterinarios/olvide-password', {email});
        ...
        <>
            ...
            <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
                ...
                <nav className='mt-10 lg:flex lg:justify-between'>
                    ...
                    <Link to="/registrar" className='block text-center my-5 text-gray-500'>¿No tienes una cuenta? <span className='font-bold'>Regístrate</span></Link>
                </nav>
            </div>
        </>
    )
