...
const Registrar = () => 
{
    ...
    const handleSubmit = async e =>
    {
        ...
        try 
        {
            await clientaAxios.post('/veterinarios', {nombre, email, password});
            ...
            <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="my-5">
                        ...
                        <input type="password" placeholder="Repite Tu Contraseña" className="border w-full p-3 mt-3 bg-gray-50 rounded-xl"  value={repetirPassword} onChange={e => setRepetirPassword(e.target.value)}/>
                    </div>
